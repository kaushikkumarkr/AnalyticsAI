...
@click.command(short_help="Initialize AnalyticsAI project")
@click.pass_context
@click.option(
    "--project",
    "-p",
...
def init(
    ...
    """Initialize AnalyticsAI environment"""
    click.echo(
        f"Initializing AnalyticsAI in directory {project}...",
    )
    ...
    click.secho(
        f"AnalyticsAI project has been initialized successfully at {click.format_filename(project)}.",
        fg="green",
    )
